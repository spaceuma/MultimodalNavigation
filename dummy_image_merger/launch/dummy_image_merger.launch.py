...
def generate_launch_description():
    default_config_file_path = os.path.join(
        ament_index_python.packages.get_package_share_directory('dummy_image_merger'),
        'config',
        'params.yaml'
    )
    ...
    image_merger_node = launch_ros.actions.LifecycleNode(package='dummy_image_merger', executable='dummy_image_merger_node',
        name='dummy_image_merger_node', namespace='', output='screen', emulate_tty=True, respawn=True,
