...
def generate_launch_description():
    # Image merger node
    image_merger_dir         = ament_index_python.packages.get_package_share_directory('image_merger')
    ...
    # Grid map publisher
    grid_map_publisher_dir        = ament_index_python.packages.get_package_share_directory('grid_map_publisher')
    grid_map_publisher_launch_dir = os.path.join(grid_map_publisher_dir, 'launch')

    return LaunchDescription([
        # Include the image merger launch file
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(image_merger_launch_dir, 'image_merger.launch.py')),
        ),
       ...
       # Include the thermal camera launch file
        ...
        # Include the grid_map_publisher launch file
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(grid_map_publisher_launch_dir, 'grid_map_publisher_headless.launch.py')),
        ),
