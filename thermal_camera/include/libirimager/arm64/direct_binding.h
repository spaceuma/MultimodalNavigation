...
/**
 * @brief Initializes an IRImager instance connected to this computer via USB. Do not use this for a direct ethernet connection.
...
/**
 * @brief Initializes an IRImager instance connected to this computer via USB for multiple cameras. Do not use this for a direct ethernet connection.
...
/**
 * @brief Set the clipped format position. For PI1M only position with x=0 are valid. (not implemented for TCP connection, usb mode only)
 * @param[in] x Upper left x position for clipped area
 * @param[in] y Upper left y position for clipped area
 * @return error code: 0 on success, -1 on error
 */
...
/**
 * @brief Get the clipped format position. Returns uint max if not set previously. (not implemented for TCP connection, usb mode only)
 * @param[out] x Upper left x position for clipped area. Returns uint max if not set previously.
 * @param[out] y Upper left y position for clipped area. Returns uint max if not set previously.
 * @return error code: 0 on success, -1 on error
 */
